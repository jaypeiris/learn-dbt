...
## What you will learn
The studio is organized into six core modules plus supporting paths and references:
...
No. The studio focuses on understanding. When you are ready to run `dbt run` or `dbt test`, use dbt Core locally or dbt Cloud.
